...
Revision ID: ee5fd3a29b0c
Revises: 
Create Date: 2022-10-26 02:23:00.041739
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "visibility", sa.Boolean(), server_default=sa.text("true"), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["quiz"], ["quizzes.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
